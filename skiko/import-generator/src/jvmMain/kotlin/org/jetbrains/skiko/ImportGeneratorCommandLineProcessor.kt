...
import org.jetbrains.skiko.ImportGeneratorConfigurationKeys.EXPORTS_PATH
...
class ImportGeneratorCommandLineProcessor : CommandLineProcessor {
    ...
    override val pluginOptions = listOf(PATH_OPTION, PREFIX_OPTION, REEXPORT_OPTION, EXPORTS_OPTION, MODULE_NAME_OPTION)
    ...
    override fun processOption(option: AbstractCliOption, value: String, configuration: CompilerConfiguration) =
        when (option) {
            ...
            EXPORTS_OPTION -> configuration.put(EXPORTS_PATH, value)
    ...
    companion object {
        ...
        val EXPORTS_OPTION = CliOption(
            EXPORTS_OPTION_NAME, "<path>",
            "path to write required WebAssembly exports",
            required = false, allowMultipleOccurrences = false
        )
