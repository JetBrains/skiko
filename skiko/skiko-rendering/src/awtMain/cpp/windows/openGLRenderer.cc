...
extern "C"
{
    ...
    JNIEXPORT void JNICALL Java_org_jetbrains_skiko_renderer_WindowsOpenGLRendererKt_setSwapInterval(JNIEnv *env, jobject renderer, jint interval)
    {
        __try
        {
    ...
    JNIEXPORT void JNICALL Java_org_jetbrains_skiko_renderer_WindowsOpenGLRendererKt_makeCurrent(JNIEnv *env, jobject renderer, jlong devicePtr, jlong contextPtr)
    {
        HDC device = fromJavaPointer<HDC>(devicePtr);
    ...
    JNIEXPORT jlong JNICALL Java_org_jetbrains_skiko_renderer_WindowsOpenGLRendererKt_createContext(JNIEnv *env, jobject renderer, jlong devicePtr, jlong contentHandle, jboolean transparency)
    {
        __try
        {
            if (transparency)
    ...
    JNIEXPORT void JNICALL Java_org_jetbrains_skiko_renderer_WindowsOpenGLRendererKt_deleteContext(JNIEnv *env, jobject renderer, jlong contextPtr)
    {
        HGLRC context = fromJavaPointer<HGLRC>(contextPtr);
        wglDeleteContext(context);
    }

    JNIEXPORT void JNICALL Java_org_jetbrains_skiko_renderer_WindowsOpenGLRendererKt_dwmFlush(JNIEnv *env, jobject renderer)
    {
        DwmFlush();
    }
}