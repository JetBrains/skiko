...
extern "C"
{
    JNIEXPORT jlong JNICALL Java_org_jetbrains_skiko_renderer_LinuxSoftwareRenderer_createDevice(
        JNIEnv *env, jobject renderer, jlong displayPtr, jlong windowPtr, jint width, jint height)
    {
