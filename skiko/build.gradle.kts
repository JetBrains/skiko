...
kotlin {
    ...
    if (supportNativeAndroid) {
        skikoProjectContext.configureNativeTarget(OS.Android, Arch.Arm64, androidNativeArm64())
        skikoProjectContext.configureNativeTarget(OS.Android, Arch.X64, androidNativeX64())
    }
