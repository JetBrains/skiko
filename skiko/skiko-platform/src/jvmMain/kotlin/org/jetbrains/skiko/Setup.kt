...
internal object Setup {
    fun init(
        noEraseBackground: Boolean = System.getProperty("skiko.platform.noerasebackground") != "false",
        globalLAF: Boolean = System.getProperty("skiko.platform.laf.global") == "true",
        useScreenMenuBar: Boolean = System.getProperty("skiko.platform.useScreenMenuBar") != "false",
