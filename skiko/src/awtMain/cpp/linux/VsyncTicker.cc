 ...
 * LinuxOpenGLRenderer's real render/present context: it needs *a* current, direct GLXContext, not
 ...
 * second-connection XOpenDisplay uses (drawlayer.cc's getDpiScale(), swingRenderer.cc's
...
// LinuxOpenGLRenderer's render/present context (no share-context; never made current anywhere else).
//
