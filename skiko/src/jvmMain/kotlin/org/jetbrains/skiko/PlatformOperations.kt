...
internal interface PlatformOperations {
    ...
    fun disableTitleBar(component: Component)
...
internal val platformOperations: PlatformOperations by lazy {
    when (hostOs) {
        OS.MacOS -> object: PlatformOperations {
                ...
                override fun disableTitleBar(component: Component) {
                    osxDisableTitleBar(component)
                }
...
external private fun osxDisableTitleBar(component: Component)
