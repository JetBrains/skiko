...
class Paint : Managed {
    ...
    var shader: Shader?
        ...
        set(value) {
            try {
                Stats.onNativeCall()
                _nSetShader(_ptr, Native.Companion.getPtr(value))
            } finally {
    ...
    var blendMode: BlendMode?
        ...
        set(value) {
            assert(value != null) { "Paint::setBlendMode expected mode != null" }
            Stats.onNativeCall()
    ...
    var pathEffect: PathEffect?
        ...
        set(value) {
            try {
                Stats.onNativeCall()
                _nSetPathEffect(_ptr, Native.Companion.getPtr(value))
            } finally {
                Reference.reachabilityFence(value)
            }
        }
