...
extern "C" JNIEXPORT void JNICALL Java_org_jetbrains_skia_ShadowUtils__1nDrawShadow
...
extern "C" JNIEXPORT int JNICALL Java_org_jetbrains_skia_ShadowUtils__1nComputeTonalAmbientColor
...
extern "C" JNIEXPORT int JNICALL Java_org_jetbrains_skia_ShadowUtils__1nComputeTonalSpotColor
  (JNIEnv* env, jclass jclass, jint ambientColor, jint spotColor) {
    SkColor outAmbientColor, outSpotColor;
    SkShadowUtils::ComputeTonalColors(ambientColor, spotColor, &outAmbientColor, &outSpotColor);
    return outSpotColor;
