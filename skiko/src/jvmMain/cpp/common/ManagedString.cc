...
extern "C" JNIEXPORT jlong JNICALL Java_org_jetbrains_skia_ManagedStringExternalKt_ManagedString_1nGetFinalizer
  (JNIEnv* env, jclass jclass) {
    return static_cast<jlong>(reinterpret_cast<uintptr_t>(&skikoMpp::finalizers::deleteString));
}

extern "C" JNIEXPORT jlong JNICALL Java_org_jetbrains_skia_ManagedStringExternalKt_ManagedString_1nMake
...
extern "C" JNIEXPORT jint JNICALL Java_org_jetbrains_skia_ManagedStringExternalKt_ManagedString_1nStringSize
  (JNIEnv* env, jclass jclass, jlong ptr) {
    SkString* instance = reinterpret_cast<SkString*>(static_cast<uintptr_t>(ptr));
    return instance->size();
}

extern "C" JNIEXPORT void JNICALL Java_org_jetbrains_skia_ManagedStringExternalKt_ManagedString_1nStringData
...
extern "C" JNIEXPORT void JNICALL Java_org_jetbrains_skia_ManagedStringExternalKt_ManagedString_1nInsert
...
extern "C" JNIEXPORT void JNICALL Java_org_jetbrains_skia_ManagedStringExternalKt_ManagedString_1nAppend
  (JNIEnv* env, jclass jclass, jlong ptr, jstring s) {
    SkString* instance = reinterpret_cast<SkString*>(static_cast<uintptr_t>(ptr));
    instance->append(skString(env, s));
}

extern "C" JNIEXPORT void JNICALL Java_org_jetbrains_skia_ManagedStringExternalKt_ManagedString_1nRemoveSuffix
...
extern "C" JNIEXPORT void JNICALL Java_org_jetbrains_skia_ManagedStringExternalKt_ManagedString_1nRemove
