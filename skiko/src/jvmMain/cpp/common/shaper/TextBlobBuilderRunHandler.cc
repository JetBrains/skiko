...
extern "C" JNIEXPORT jlong JNICALL Java_org_jetbrains_skia_shaper_TextBlobBuilderRunHandler__1nGetFinalizer
  (JNIEnv* env, jclass jclass) {
    return static_cast<jlong>(reinterpret_cast<uintptr_t>(&deleteTextBlobBuilderRunHandler));
}

extern "C" JNIEXPORT jlong JNICALL Java_org_jetbrains_skia_shaper_TextBlobBuilderRunHandler__1nMake
...
extern "C" JNIEXPORT jlong JNICALL Java_org_jetbrains_skia_shaper_TextBlobBuilderRunHandler__1nMakeBlob
