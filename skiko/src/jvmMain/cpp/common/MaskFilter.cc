...
extern "C" JNIEXPORT jlong JNICALL Java_org_jetbrains_skia_MaskFilterExternalKt_MaskFilter_1nMakeBlur
...
extern "C" JNIEXPORT jlong JNICALL Java_org_jetbrains_skia_MaskFilterExternalKt_MaskFilter_1nMakeShader
...
// extern "C" JNIEXPORT jlong JNICALL Java_org_jetbrains_skia_MaskFilterExternalKt_MaskFilter_1nMakeEmboss
...
extern "C" JNIEXPORT jlong JNICALL Java_org_jetbrains_skia_MaskFilterExternalKt_MaskFilter_1nMakeTable
...
extern "C" JNIEXPORT jlong JNICALL Java_org_jetbrains_skia_MaskFilterExternalKt_MaskFilter_1nMakeGamma
  (JNIEnv* env, jclass jclass, jfloat gamma) {
    SkMaskFilter* ptr = SkTableMaskFilter::CreateGamma(gamma);
    return reinterpret_cast<jlong>(ptr);
}

extern "C" JNIEXPORT jlong JNICALL Java_org_jetbrains_skia_MaskFilterExternalKt_MaskFilter_1nMakeClip
