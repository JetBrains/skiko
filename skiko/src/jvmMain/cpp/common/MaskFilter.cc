...
extern "C" JNIEXPORT jlong JNICALL Java_org_jetbrains_skia_MaskFilter__1nMakeBlur
...
extern "C" JNIEXPORT jlong JNICALL Java_org_jetbrains_skia_MaskFilter__1nMakeShader
...
// extern "C" JNIEXPORT jlong JNICALL Java_org_jetbrains_skia_MaskFilter__1nMakeEmboss
...
extern "C" JNIEXPORT jlong JNICALL Java_org_jetbrains_skia_MaskFilter__1nMakeTable
...
extern "C" JNIEXPORT jlong JNICALL Java_org_jetbrains_skia_MaskFilter__1nMakeGamma
  (JNIEnv* env, jclass jclass, jfloat gamma) {
    SkMaskFilter* ptr = SkTableMaskFilter::CreateGamma(gamma);
    return reinterpret_cast<jlong>(ptr);
}

extern "C" JNIEXPORT jlong JNICALL Java_org_jetbrains_skia_MaskFilter__1nMakeClip
