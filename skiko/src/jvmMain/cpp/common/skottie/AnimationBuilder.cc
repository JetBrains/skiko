...
extern "C" JNIEXPORT jlong JNICALL Java_org_jetbrains_skia_skottie_AnimationBuilderExternalKt_AnimationBuilder_1nGetFinalizer
  (JNIEnv* env, jclass jclass) {
    return static_cast<jlong>(reinterpret_cast<uintptr_t>(&deleteAnimationBuilder));
}

extern "C" JNIEXPORT jlong JNICALL Java_org_jetbrains_skia_skottie_AnimationBuilderExternalKt_AnimationBuilder_1nMake
  (JNIEnv* env, jclass jclass, jint flags) {
    return reinterpret_cast<jlong>(new Animation::Builder(flags));
}

extern "C" JNIEXPORT void JNICALL Java_org_jetbrains_skia_skottie_AnimationBuilderExternalKt_AnimationBuilder_1nSetFontManager
...
extern "C" JNIEXPORT void JNICALL Java_org_jetbrains_skia_skottie_AnimationBuilderExternalKt_AnimationBuilder_1nSetLogger
...
extern "C" JNIEXPORT jlong JNICALL Java_org_jetbrains_skia_skottie_AnimationBuilderExternalKt_AnimationBuilder_1nBuildFromString
...
extern "C" JNIEXPORT jlong JNICALL Java_org_jetbrains_skia_skottie_AnimationBuilderExternalKt_AnimationBuilder_1nBuildFromFile
...
extern "C" JNIEXPORT jlong JNICALL Java_org_jetbrains_skia_skottie_AnimationBuilderExternalKt_AnimationBuilder_1nBuildFromData
