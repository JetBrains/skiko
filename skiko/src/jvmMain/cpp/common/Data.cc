...
extern "C" JNIEXPORT jlong JNICALL Java_org_jetbrains_skia_DataExternalKt_Data_1nGetFinalizer(JNIEnv* env, jclass jclass) {
    return static_cast<jlong>(reinterpret_cast<uintptr_t>(&deleteData));
}

extern "C" JNIEXPORT jint JNICALL Java_org_jetbrains_skia_DataExternalKt_Data_1nSize
  (JNIEnv* env, jclass jclass, jlong ptr) {
    SkData* instance = reinterpret_cast<SkData*>(static_cast<uintptr_t>(ptr));
    return instance->size();
}

extern "C" JNIEXPORT jobject JNICALL Java_org_jetbrains_skia_DataExternalKt_Data_1nToByteBuffer
  (JNIEnv* env, jclass jclass, jlong ptr) {
    SkData* instance = reinterpret_cast<SkData*>(static_cast<uintptr_t>(ptr));
    return env->NewDirectByteBuffer(instance->writable_data(), instance->size());
}

extern "C" JNIEXPORT void JNICALL Java_org_jetbrains_skia_DataExternalKt_Data_1nBytes
...
extern "C" JNIEXPORT jboolean JNICALL Java_org_jetbrains_skia_DataExternalKt_Data_1nEquals
...
extern "C" JNIEXPORT jlong JNICALL Java_org_jetbrains_skia_DataExternalKt_Data_1nMakeFromBytes
...
extern "C" JNIEXPORT jlong JNICALL Java_org_jetbrains_skia_DataExternalKt_Data_1nMakeWithoutCopy
...
extern "C" JNIEXPORT jlong JNICALL Java_org_jetbrains_skia_DataExternalKt_Data_1nMakeFromFileName
...
extern "C" JNIEXPORT jlong JNICALL Java_org_jetbrains_skia_DataExternalKt_Data_1nMakeSubset
...
extern "C" JNIEXPORT jlong JNICALL Java_org_jetbrains_skia_DataExternalKt_Data_1nMakeEmpty
  (JNIEnv* env, jclass jclass) {
    SkData* instance = SkData::MakeEmpty().release();
    return reinterpret_cast<jlong>(instance);
}

extern "C" JNIEXPORT jlong JNICALL Java_org_jetbrains_skia_DataExternalKt_Data_1nMakeUninitialized
  (JNIEnv* env, jclass jclass, jint length) {
    SkData* instance = SkData::MakeUninitialized(length).release();
    return reinterpret_cast<jlong>(instance);
}

extern "C" JNIEXPORT jlong JNICALL Java_org_jetbrains_skia_DataExternalKt_Data_1nWritableData
  (JNIEnv* env, jclass jclass, jlong ptr) {
    SkData* instance = reinterpret_cast<SkData*>(static_cast<uintptr_t>(ptr));
