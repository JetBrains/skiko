...
extern "C" JNIEXPORT jint JNICALL Java_org_jetbrains_skia_icu_UnicodeExternalKt_Unicode_1nCharDirection
  (JNIEnv* env, jclass jclass, jint codePoint) {
    return u_charDirection(codePoint);
}

extern "C" JNIEXPORT jboolean JNICALL Java_org_jetbrains_skia_icu_UnicodeExternalKt_Unicode_1nCodePointHasBinaryProperty
