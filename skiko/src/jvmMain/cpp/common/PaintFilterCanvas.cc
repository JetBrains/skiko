...
extern "C" JNIEXPORT void JNICALL Java_org_jetbrains_skia_PaintFilterCanvas__1nAttachToJava
...
extern "C" JNIEXPORT jlong JNICALL Java_org_jetbrains_skia_PaintFilterCanvas__1nMake
