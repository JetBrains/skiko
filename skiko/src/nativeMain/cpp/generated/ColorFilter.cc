...
extern "C" jlong org_jetbrains_skia_ColorFilter__1nMakeLerp
  (jfloat t, jlong dstPtr, jlong srcPtr) {
...
extern "C" jlong org_jetbrains_skia_ColorFilter__1nMakeHighContrast
  (jboolean grayscale, jint inverionModeInt, jfloat contrast) {
...
extern "C" jlong org_jetbrains_skia_ColorFilter__1nMakeTableARGB
  (jbyteArray arrayA, jbyteArray arrayR, jbyteArray arrayG, jbyteArray arrayB) {
...
extern "C" jlong org_jetbrains_skia_ColorFilter__1nMakeOverdraw
  (jint c0, jint c1, jint c2, jint c3, jint c4, jint c5) {
    SkColor colors[6];
    colors[0] = c0;
    colors[1] = c1;
    colors[2] = c2;
