...
extern "C" jlong org_jetbrains_skia_shaper_ManagedRunIteratorKt__1nGetFinalizer(kref __Kinstance) {
    return static_cast<jlong>(reinterpret_cast<uintptr_t>(&deleteRunIterator));
}

extern "C" void org_jetbrains_skia_shaper_ManagedRunIteratorKt__1nConsume
  (kref __Kinstance, jlong ptr) {
    SkShaper::RunIterator* instance = reinterpret_cast<SkShaper::RunIterator*>(static_cast<uintptr_t>(ptr));
    instance->consume();
}

extern "C" jint org_jetbrains_skia_shaper_ManagedRunIteratorKt__1nGetEndOfCurrentRun
...
extern "C" jboolean org_jetbrains_skia_shaper_ManagedRunIteratorKt__1nIsAtEnd
  (kref __Kinstance, jlong ptr) {
    SkShaper::RunIterator* instance = reinterpret_cast<SkShaper::RunIterator*>(static_cast<uintptr_t>(ptr));
