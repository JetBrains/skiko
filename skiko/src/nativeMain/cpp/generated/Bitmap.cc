...
extern "C" jlong org_jetbrains_skia_Bitmap__1nGetFinalizer() {
...
extern "C" jboolean org_jetbrains_skia_Bitmap__1nSetImageInfo
  (jlong ptr, jint width, jint height, jint colorType, jint alphaType, jlong colorSpacePtr, jlong rowBytes) {
    SkBitmap* instance = reinterpret_cast<SkBitmap*>(static_cast<uintptr_t>(ptr));
...
extern "C" jboolean org_jetbrains_skia_Bitmap__1nAllocPixelsFlags
  (jlong ptr, jint width, jint height, jint colorType, jint alphaType, jlong colorSpacePtr, jint flags) {
    SkBitmap* instance = reinterpret_cast<SkBitmap*>(static_cast<uintptr_t>(ptr));
    SkColorSpace* colorSpace = reinterpret_cast<SkColorSpace*>(static_cast<uintptr_t>(colorSpacePtr));
    SkImageInfo imageInfo = SkImageInfo::Make(width,
                                              height,
...
extern "C" jboolean org_jetbrains_skia_Bitmap__1nInstallPixels
  (jlong ptr, jint width, jint height, jint colorType, jint alphaType, jlong colorSpacePtr, jbyteArray pixelsArr, jlong rowBytes) {
...
extern "C" void org_jetbrains_skia_Bitmap__1nSetPixelRef
  (jlong ptr, jlong pixelRefPtr, jint dx, jint dy) {
    SkBitmap* instance = reinterpret_cast<SkBitmap*>(static_cast<uintptr_t>(ptr));
...
extern "C" void org_jetbrains_skia_Bitmap__1nErase
  (jlong ptr, jint color, jint left, jint top, jint right, jint bottom) {
    SkBitmap* instance = reinterpret_cast<SkBitmap*>(static_cast<uintptr_t>(ptr));
...
extern "C" jboolean org_jetbrains_skia_Bitmap__1nExtractSubset
  (jlong ptr, jlong dstPtr, jint left, jint top, jint right, jint bottom) {
    SkBitmap* instance = reinterpret_cast<SkBitmap*>(static_cast<uintptr_t>(ptr));
...
extern "C" jbyteArray org_jetbrains_skia_Bitmap__1nReadPixels
  (jlong ptr, jint width, jint height, jint colorType, jint alphaType, jlong colorSpacePtr, jlong rowBytes, jint srcX, jint srcY) {
...
extern "C" jobject org_jetbrains_skia_Bitmap__1nExtractAlpha
  (jlong ptr, jlong dstPtr, jlong paintPtr) {
...
extern "C" jlong org_jetbrains_skia_Bitmap__1nMakeShader
  (jlong ptr, jint tmx, jint tmy, jlong samplingMode, jfloatArray localMatrixArr) {
