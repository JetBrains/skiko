...
extern "C" jlong org_jetbrains_skia_ImageFilter__1nMakeAlphaThreshold
  (jlong regionPtr, jfloat innerMin, jfloat outerMax, jlong inputPtr, jobject cropObj) {
...
extern "C" jlong org_jetbrains_skia_ImageFilter__1nMakeArithmetic
  (jfloat k1, jfloat k2, jfloat k3, jfloat k4, jboolean enforcePMColor, jlong bgPtr, jlong fgPtr, jobject cropObj) {
...
extern "C" jlong org_jetbrains_skia_ImageFilter__1nMakeBlend
  (jint blendModeInt, jlong bgPtr, jlong fgPtr, jobject cropObj) {
...
extern "C" jlong org_jetbrains_skia_ImageFilter__1nMakeBlur
  (jfloat sigmaX, jfloat sigmaY, jint tileModeInt, jlong inputPtr, jobject cropObj) {
...
extern "C" jlong org_jetbrains_skia_ImageFilter__1nMakeColorFilter
  (jlong colorFilterPtr, jlong inputPtr, jobject cropObj) {
...
extern "C" jlong org_jetbrains_skia_ImageFilter__1nMakeDisplacementMap
  (jint xChanInt, jint yChanInt, jfloat scale, jlong displacementPtr, jlong colorPtr, jobject cropObj) {
...
extern "C" jlong org_jetbrains_skia_ImageFilter__1nMakeDropShadow
  (jfloat dx, jfloat dy, jfloat sigmaX, jfloat sigmaY, jint color, jlong inputPtr, jobject cropObj) {
...
extern "C" jlong org_jetbrains_skia_ImageFilter__1nMakeImage
  (jlong imagePtr, jfloat l0, jfloat t0, jfloat r0, jfloat b0, jfloat l1, jfloat t1, jfloat r1, jfloat b1, jlong samplingMode) {
...
extern "C" jlong org_jetbrains_skia_ImageFilter__1nMakeMagnifier
  (jfloat l, jfloat t, jfloat r, jfloat b, jfloat inset, jlong inputPtr, jobject cropObj) {
...
extern "C" jlong org_jetbrains_skia_ImageFilter__1nMakeMatrixConvolution
  (jint kernelW, jint kernelH, jfloatArray kernelArray, jfloat gain, jfloat bias, jint offsetX, jint offsetY, jint tileModeInt, jboolean convolveAlpha, jlong inputPtr, jobject cropObj) {
...
extern "C" jlong org_jetbrains_skia_ImageFilter__1nMakeMatrixTransform
  (jfloatArray matrixArray, jlong samplingMode, jlong inputPtr) {
...
extern "C" jlong org_jetbrains_skia_ImageFilter__1nMakeMerge
  (jlongArray filtersArray, jobject cropObj) {
...
extern "C" jlong org_jetbrains_skia_ImageFilter__1nMakeOffset
  (jfloat dx, jfloat dy, jlong inputPtr, jobject cropObj) {
...
extern "C" jlong org_jetbrains_skia_ImageFilter__1nMakePaint
  (jlong paintPtr, jobject cropObj) {
...
extern "C" jlong org_jetbrains_skia_ImageFilter__1nMakePicture
  (jlong picturePtr, jfloat l, jfloat t, jfloat r, jfloat b) {
...
extern "C" jlong org_jetbrains_skia_ImageFilter__1nMakeTile
  (jfloat l0, jfloat t0, jfloat r0, jfloat b0, jfloat l1, jfloat t1, jfloat r1, jfloat b1, jlong inputPtr) {
    SkImageFilter* input = reinterpret_cast<SkImageFilter*>(static_cast<uintptr_t>(inputPtr));
...
extern "C" jlong org_jetbrains_skia_ImageFilter__1nMakeDilate
  (float rx, jfloat ry, jlong inputPtr, jobject cropObj) {
...
extern "C" jlong org_jetbrains_skia_ImageFilter__1nMakeDistantLitDiffuse
  (jfloat x, jfloat y, jfloat z, jint lightColor, jfloat surfaceScale, jfloat kd, jlong inputPtr, jobject cropObj) {
...
extern "C" jlong org_jetbrains_skia_ImageFilter__1nMakeSpotLitDiffuse
  (jfloat x0, jfloat y0, jfloat z0, jfloat x1, jfloat y1, jfloat z1, jfloat falloffExponent, jfloat cutoffAngle, jint lightColor, jfloat surfaceScale, jfloat kd, jlong inputPtr, jobject cropObj) {
...
extern "C" jlong org_jetbrains_skia_ImageFilter__1nMakeDistantLitSpecular
  (jfloat x, jfloat y, jfloat z, jint lightColor, jfloat surfaceScale, jfloat ks, jfloat shininess, jlong inputPtr, jobject cropObj) {
...
extern "C" jlong org_jetbrains_skia_ImageFilter__1nMakeSpotLitSpecular
  (jfloat x0, jfloat y0, jfloat z0, jfloat x1, jfloat y1, jfloat z1, jfloat falloffExponent, jfloat cutoffAngle, jint lightColor, jfloat surfaceScale, jfloat ks, jfloat shininess, jlong inputPtr, jobject cropObj) {
