...
private class DisplayLinkConditions(
    ...
    /**
     * see [MetalRenderer.needsProactiveDisplayLink]
     */
...
internal class MetalRenderer(
    ...
    private val disposeCallback: (MetalRenderer) -> Unit = { }
) {
    ...
    init {
        val caDisplayLink = caDisplayLink ?: throw IllegalStateException("caDisplayLink is null during renderer init")
    ...
    internal fun dispose() {
        check(caDisplayLink != null, { "MetalRenderer.dispose() was called more than once" })
