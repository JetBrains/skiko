 ...
 *
 * A [Redrawer] owns both the frame loop (when to render and present a frame) and the Skia objects the content is
...
internal abstract class Redrawer(
    ...
    /**
     * Human-readable information about this redrawer and the device it draws on.
     */
