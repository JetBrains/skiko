...
@ExternalCode("Module['asm']['org_jetbrains_skia_Drawable__1nDraw']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Drawable__1nMakePictureSnapshot']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Drawable__1nNotifyDrawingChanged']")
private external fun _nNotifyDrawingChanged(ptr: NativePointer)

@ExternalSymbolName("org_jetbrains_skia_Drawable__1nGetBounds")
@ExternalCode("Module['asm']['org_jetbrains_skia_Drawable__1nGetBounds']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Drawable__1nInit']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Drawable__1nGetOnDrawCanvas']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Drawable__1nSetBounds']")
