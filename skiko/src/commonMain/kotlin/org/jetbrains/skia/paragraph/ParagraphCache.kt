...
@ExternalCode("Module['asm']['org_jetbrains_skia_paragraph_ParagraphCache__1nAbandon']")
private external fun _nAbandon(ptr: NativePointer)

@ExternalSymbolName("org_jetbrains_skia_paragraph_ParagraphCache__1nReset")
@ExternalCode("Module['asm']['org_jetbrains_skia_paragraph_ParagraphCache__1nReset']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_paragraph_ParagraphCache__1nUpdateParagraph']")
private external fun _nUpdateParagraph(ptr: NativePointer, paragraphPtr: NativePointer): @InteropType Boolean

@ExternalSymbolName("org_jetbrains_skia_paragraph_ParagraphCache__1nFindParagraph")
@ExternalCode("Module['asm']['org_jetbrains_skia_paragraph_ParagraphCache__1nFindParagraph']")
private external fun _nFindParagraph(ptr: NativePointer, paragraphPtr: NativePointer): @InteropType Boolean

@ExternalSymbolName("org_jetbrains_skia_paragraph_ParagraphCache__1nPrintStatistics")
@ExternalCode("Module['asm']['org_jetbrains_skia_paragraph_ParagraphCache__1nPrintStatistics']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_paragraph_ParagraphCache__1nSetEnabled']")
private external fun _nSetEnabled(ptr: NativePointer, value: @InteropType Boolean)

@ExternalSymbolName("org_jetbrains_skia_paragraph_ParagraphCache__1nGetCount")
@ExternalCode("Module['asm']['org_jetbrains_skia_paragraph_ParagraphCache__1nGetCount']")
