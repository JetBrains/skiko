...
@ExternalCode("Module['asm']['org_jetbrains_skia_Shader__1nMakeEmpty']")
private external fun Shader_nMakeEmpty(): NativePointer

@ExternalSymbolName("org_jetbrains_skia_Shader__1nMakeWithColorFilter")
@ExternalCode("Module['asm']['org_jetbrains_skia_Shader__1nMakeWithColorFilter']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Shader__1nMakeLinearGradient']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Shader__1nMakeLinearGradientCS']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Shader__1nMakeRadialGradient']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Shader__1nMakeRadialGradientCS']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Shader__1nMakeTwoPointConicalGradient']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Shader__1nMakeTwoPointConicalGradientCS']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Shader__1nMakeSweepGradient']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Shader__1nMakeSweepGradientCS']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Shader__1nMakeFractalNoise']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Shader__1nMakeTurbulence']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Shader__1nMakeColor']")
private external fun _nMakeColor(color: Int): NativePointer

@ExternalSymbolName("org_jetbrains_skia_Shader__1nMakeColorCS")
@ExternalCode("Module['asm']['org_jetbrains_skia_Shader__1nMakeColorCS']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Shader__1nMakeBlend']")
