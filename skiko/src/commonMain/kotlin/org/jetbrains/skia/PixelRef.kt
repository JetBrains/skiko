...
@ExternalCode("Module['asm']['org_jetbrains_skia_PixelRef__1nGetRowBytes']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_PixelRef__1nGetGenerationId']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_PixelRef__1nNotifyPixelsChanged']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_PixelRef__1nIsImmutable']")
private external fun PixelRef_nIsImmutable(ptr: NativePointer): @InteropType Boolean

@ExternalSymbolName("org_jetbrains_skia_PixelRef__1nSetImmutable")
@ExternalCode("Module['asm']['org_jetbrains_skia_PixelRef__1nSetImmutable']")
private external fun PixelRef_nSetImmutable(ptr: NativePointer)

@ExternalSymbolName("org_jetbrains_skia_PixelRef__1nGetWidth")
@ExternalCode("Module['asm']['org_jetbrains_skia_PixelRef__1nGetWidth']")
private external fun _nGetWidth(ptr: NativePointer): Int

@ExternalSymbolName("org_jetbrains_skia_PixelRef__1nGetHeight")
@ExternalCode("Module['asm']['org_jetbrains_skia_PixelRef__1nGetHeight']")
