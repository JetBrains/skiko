...
@ExternalCode("Module['asm']['org_jetbrains_skia_Pixmap__1nGetFinalizer']")
private external fun Pixmap_nGetFinalizer(): NativePointer

@ExternalSymbolName("org_jetbrains_skia_Pixmap__1nReset")
@ExternalCode("Module['asm']['org_jetbrains_skia_Pixmap__1nReset']")
private external fun Pixmap_nReset(ptr: NativePointer)

@ExternalSymbolName("org_jetbrains_skia_Pixmap__1nExtractSubset")
@ExternalCode("Module['asm']['org_jetbrains_skia_Pixmap__1nExtractSubset']")
private external fun Pixmap_nExtractSubset(ptr: NativePointer, subsetPtr: NativePointer, l: Int, t: Int, r: Int, b: Int): @InteropType Boolean

@ExternalSymbolName("org_jetbrains_skia_Pixmap__1nGetRowBytes")
@ExternalCode("Module['asm']['org_jetbrains_skia_Pixmap__1nGetRowBytes']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Pixmap__1nGetRowBytesAsPixels']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Pixmap__1nComputeByteSize']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Pixmap__1nComputeIsOpaque']")
private external fun Pixmap_nComputeIsOpaque(ptr: NativePointer): @InteropType Boolean

@ExternalSymbolName("org_jetbrains_skia_Pixmap__1nGetColor")
@ExternalCode("Module['asm']['org_jetbrains_skia_Pixmap__1nGetColor']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Pixmap__1nMakeNull']")
private external fun _nMakeNull(): NativePointer

@ExternalSymbolName("org_jetbrains_skia_Pixmap__1nMake")
@ExternalCode("Module['asm']['org_jetbrains_skia_Pixmap__1nMake']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Pixmap__1nResetWithInfo']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Pixmap__1nSetColorSpace']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Pixmap__1nGetInfo']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Pixmap__1nGetAddr']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Pixmap__1nGetAlphaF']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Pixmap__1nGetAddrAt']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Pixmap__1nReadPixels']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Pixmap__1nReadPixelsFromPoint']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Pixmap__1nReadPixelsToPixmap']")
private external fun _nReadPixelsToPixmap(ptr: NativePointer, dstPixmapPtr: NativePointer): @InteropType Boolean

@ExternalSymbolName("org_jetbrains_skia_Pixmap__1nReadPixelsToPixmapFromPoint")
@ExternalCode("Module['asm']['org_jetbrains_skia_Pixmap__1nReadPixelsToPixmapFromPoint']")
private external fun _nReadPixelsToPixmapFromPoint(ptr: NativePointer, dstPixmapPtr: NativePointer, srcX: Int, srcY: Int): @InteropType Boolean

@ExternalSymbolName("org_jetbrains_skia_Pixmap__1nScalePixels")
@ExternalCode("Module['asm']['org_jetbrains_skia_Pixmap__1nScalePixels']")
private external fun _nScalePixels(ptr: NativePointer, dstPixmapPtr: NativePointer, samplingOptionsVal1: Int, samplingOptionsVal2: Int): @InteropType Boolean

@ExternalSymbolName("org_jetbrains_skia_Pixmap__1nErase")
@ExternalCode("Module['asm']['org_jetbrains_skia_Pixmap__1nErase']")
private external fun _nErase(ptr: NativePointer, color: Int): @InteropType Boolean

@ExternalSymbolName("org_jetbrains_skia_Pixmap__1nEraseSubset")
@ExternalCode("Module['asm']['org_jetbrains_skia_Pixmap__1nEraseSubset']")
private external fun _nEraseSubset(
    ...
    r: Int,
    b: Int
): @InteropType Boolean // TODO float erase methods not included
