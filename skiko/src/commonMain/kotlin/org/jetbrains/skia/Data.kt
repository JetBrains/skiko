...
@ExternalCode("Module['asm']['org_jetbrains_skia_Data__1nEquals']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Data__1nMakeFromBytes']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Data__1nMakeWithoutCopy']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Data__1nMakeFromFileName']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Data__1nMakeSubset']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Data__1nMakeEmpty']")
private external fun _nMakeEmpty(): NativePointer

@ExternalSymbolName("org_jetbrains_skia_Data__1nMakeUninitialized")
@ExternalCode("Module['asm']['org_jetbrains_skia_Data__1nMakeUninitialized']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Data__1nWritableData']")
