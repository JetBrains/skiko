...
@ModuleImport("org_jetbrains_skia_ColorFilter__1nMakeComposed")
...
@ModuleImport("org_jetbrains_skia_ColorFilter__1nMakeBlend")
...
@ModuleImport("org_jetbrains_skia_ColorFilter__1nMakeMatrix")
...
@ModuleImport("org_jetbrains_skia_ColorFilter__1nMakeHSLAMatrix")
...
@ModuleImport("org_jetbrains_skia_ColorFilter__1nGetLinearToSRGBGamma")
...
@ModuleImport("org_jetbrains_skia_ColorFilter__1nGetSRGBToLinearGamma")
private external fun _nGetSRGBToLinearGamma(): NativePointer

@ExternalSymbolName("org_jetbrains_skia_ColorFilter__1nMakeLerp")
@ModuleImport("org_jetbrains_skia_ColorFilter__1nMakeLerp")
...
@ModuleImport("org_jetbrains_skia_ColorFilter__1nMakeLighting")
...
@ModuleImport("org_jetbrains_skia_ColorFilter__1nMakeHighContrast")
...
@ModuleImport("org_jetbrains_skia_ColorFilter__1nMakeTable")
...
@ModuleImport("org_jetbrains_skia_ColorFilter__1nMakeOverdraw")
...
@ModuleImport("org_jetbrains_skia_ColorFilter__1nGetLuma")
private external fun _nGetLuma(): NativePointer

@ExternalSymbolName("org_jetbrains_skia_ColorFilter__1nMakeTableARGB")
@ModuleImport("org_jetbrains_skia_ColorFilter__1nMakeTableARGB")
