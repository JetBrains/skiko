...
@ExternalCode("Module['asm']['org_jetbrains_skia_TextLine__1nGetFinalizer']")
private external fun TextLine_nGetFinalizer(): NativePointer

@ExternalSymbolName("org_jetbrains_skia_TextLine__1nGetWidth")
@ExternalCode("Module['asm']['org_jetbrains_skia_TextLine__1nGetWidth']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_TextLine__1nGetHeight']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_TextLine__1nGetGlyphsLength']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_TextLine__1nGetGlyphs']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_TextLine__1nGetPositions']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_TextLine__1nGetRunPositions']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_TextLine__1nGetRunPositionsCount']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_TextLine__1nGetBreakPositionsCount']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_TextLine__1nGetBreakPositions']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_TextLine__1nGetBreakOffsetsCount']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_TextLine__1nGetBreakOffsets']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_TextLine__1nGetOffsetAtCoord']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_TextLine__1nGetLeftOffsetAtCoord']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_TextLine__1nGetCoordAtOffset']")
