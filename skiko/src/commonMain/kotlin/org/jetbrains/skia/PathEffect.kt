...
@ExternalCode("Module['asm']['org_jetbrains_skia_PathEffect__1nMakeCompose']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_PathEffect__1nMakeSum']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_PathEffect__1nMakePath1D']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_PathEffect__1nMakePath2D']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_PathEffect__1nMakeLine2D']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_PathEffect__1nMakeCorner']")
private external fun _nMakeCorner(radius: Float): NativePointer

@ExternalSymbolName("org_jetbrains_skia_PathEffect__1nMakeDash")
@ExternalCode("Module['asm']['org_jetbrains_skia_PathEffect__1nMakeDash']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_PathEffect__1nMakeDiscrete']")
