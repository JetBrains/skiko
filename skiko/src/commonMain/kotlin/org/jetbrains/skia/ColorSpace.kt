...
@ExternalCode("Module['asm']['org_jetbrains_skia_ColorSpace__1nGetFinalizer']")
private external fun ColorSpace_nGetFinalizer(): NativePointer

@ExternalSymbolName("org_jetbrains_skia_ColorSpace__nConvert")
@ExternalCode("Module['asm']['org_jetbrains_skia_ColorSpace__nConvert']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_ColorSpace__1nIsGammaCloseToSRGB']")
private external fun _nIsGammaCloseToSRGB(ptr: NativePointer): @InteropType Boolean

@ExternalSymbolName("org_jetbrains_skia_ColorSpace__1nIsGammaLinear")
@ExternalCode("Module['asm']['org_jetbrains_skia_ColorSpace__1nIsGammaLinear']")
private external fun _nIsGammaLinear(ptr: NativePointer): @InteropType Boolean

@ExternalSymbolName("org_jetbrains_skia_ColorSpace__1nIsSRGB")
@ExternalCode("Module['asm']['org_jetbrains_skia_ColorSpace__1nIsSRGB']")
private external fun _nIsSRGB(ptr: NativePointer): @InteropType Boolean
