...
@ExternalCode("Module['asm']['org_jetbrains_skia_shaper_Shaper__1nGetFinalizer']")
private external fun Shaper_nGetFinalizer(): NativePointer

@ExternalSymbolName("org_jetbrains_skia_shaper_Shaper__1nMake")
@ExternalCode("Module['asm']['org_jetbrains_skia_shaper_Shaper__1nMake']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_shaper_Shaper__1nMakePrimitive']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_shaper_Shaper__1nMakeShaperDrivenWrapper']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_shaper_Shaper__1nMakeShapeThenWrap']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_shaper_Shaper__1nMakeShapeDontWrapOrReorder']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_shaper_Shaper__1nMakeCoreText']")
private external fun _nMakeCoreText(): NativePointer

@ExternalSymbolName("org_jetbrains_skia_shaper_Shaper__1nShapeBlob")
@ExternalCode("Module['asm']['org_jetbrains_skia_shaper_Shaper__1nShapeBlob']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_shaper_Shaper__1nShapeLine']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_shaper_Shaper__1nShape']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_shaper_Shaper_RunIterator_1nGetFinalizer']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_shaper_Shaper_RunIterator_1nCreateRunIterator']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_shaper_Shaper_RunIterator_1nInitRunIterator']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_shaper_Shaper_RunHandler_1nCreate']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_shaper_Shaper_RunHandler_1nGetFinalizer']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_shaper_Shaper_RunHandler_1nInit']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_shaper_Shaper_RunHandler_1nGetGlyphs']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_shaper_Shaper_RunHandler_1nGetClusters']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_shaper_Shaper_RunHandler_1nGetPositions']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_shaper_Shaper_RunHandler_1nSetOffset']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_shaper_Shaper_RunHandler_1nGetRunInfo']")
