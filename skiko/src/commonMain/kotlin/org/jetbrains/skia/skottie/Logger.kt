...
@ModuleImport("org_jetbrains_skia_skottie_Logger__1nMake")
private external fun _nMake(): NativePointer

// Native/JS only

@ExternalSymbolName("org_jetbrains_skia_skottie_Logger__1nInit")
@ModuleImport("org_jetbrains_skia_skottie_Logger__1nInit")
...
@ModuleImport("org_jetbrains_skia_skottie_Logger__1nGetLogMessage")
...
@ModuleImport("org_jetbrains_skia_skottie_Logger__1nGetLogJson")
...
@ModuleImport("org_jetbrains_skia_skottie_Logger__1nGetLogLevel")
