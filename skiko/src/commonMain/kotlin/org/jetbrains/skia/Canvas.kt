...
@ExternalCode("Module['asm']['org_jetbrains_skia_Canvas__1nGetFinalizer']")
private external fun Canvas_nGetFinalizer(): NativePointer

@ExternalSymbolName("org_jetbrains_skia_Canvas__1nMakeFromBitmap")
@ExternalCode("Module['asm']['org_jetbrains_skia_Canvas__1nMakeFromBitmap']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Canvas__1nDrawPoint']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Canvas__1nDrawPoints']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Canvas__1nDrawLine']")
...
@ExternalCode("(ptr, left, top, right, bottom, startAngle, sweepAngle, includeCenter) => Module['asm']['org_jetbrains_skia_Canvas__1nDrawArc'](ptr, left, top, right, bottom, startAngle, sweepAngle, includeCenter)")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Canvas__1nDrawRect']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Canvas__1nDrawOval']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Canvas__1nDrawRRect']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Canvas__1nDrawDRRect']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Canvas__1nDrawPath']")
...
@ExternalCode("(ptr, nativeImage, sl, st, sr, sb, dl, dt, dr, db, samplingModeVal1, samplingModeVal2, paintPtr, strictn) => Module['asm']['org_jetbrains_skia_Canvas__1nDrawImageRect'](ptr, nativeImage, sl, st, sr, sb, dl, dt, dr, db, samplingModeVal1, samplingModeVal2, paintPtr, strictn)")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Canvas__1nDrawImageNine']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Canvas__1nDrawRegion']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Canvas__1nDrawString']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Canvas__1nDrawTextBlob']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Canvas__1nDrawPicture']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Canvas__1nDrawVertices']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Canvas__1nDrawPatch']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Canvas__1nDrawDrawable']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Canvas__1nClear']")
private external fun _nClear(ptr: NativePointer, color: Int)

@ExternalSymbolName("org_jetbrains_skia_Canvas__1nDrawPaint")
@ExternalCode("Module['asm']['org_jetbrains_skia_Canvas__1nDrawPaint']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Canvas__1nSetMatrix']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Canvas__1nGetLocalToDevice']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Canvas__1nResetMatrix']")
private external fun _nResetMatrix(ptr: NativePointer)

@ExternalSymbolName("org_jetbrains_skia_Canvas__1nClipRect")
@ExternalCode("Module['asm']['org_jetbrains_skia_Canvas__1nClipRect']")
private external fun _nClipRect(
    ...
    bottom: Float,
    mode: Int,
    antiAlias: @InteropType Boolean
)

@ExternalSymbolName("org_jetbrains_skia_Canvas__1nClipRRect")
@ExternalCode("Module['asm']['org_jetbrains_skia_Canvas__1nClipRRect']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Canvas__1nClipPath']")
private external fun _nClipPath(ptr: NativePointer, nativePath: NativePointer, mode: Int, antiAlias: @InteropType Boolean)

@ExternalSymbolName("org_jetbrains_skia_Canvas__1nClipRegion")
@ExternalCode("Module['asm']['org_jetbrains_skia_Canvas__1nClipRegion']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Canvas__1nConcat']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Canvas__1nConcat44']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Canvas__1nReadPixels']")
private external fun _nReadPixels(ptr: NativePointer, bitmapPtr: NativePointer, srcX: Int, srcY: Int): @InteropType Boolean

@ExternalSymbolName("org_jetbrains_skia_Canvas__1nWritePixels")
@ExternalCode("Module['asm']['org_jetbrains_skia_Canvas__1nWritePixels']")
private external fun _nWritePixels(ptr: NativePointer, bitmapPtr: NativePointer, x: Int, y: Int): @InteropType Boolean

@ExternalSymbolName("org_jetbrains_skia_Canvas__1nSave")
@ExternalCode("Module['asm']['org_jetbrains_skia_Canvas__1nSave']")
private external fun _nSave(ptr: NativePointer): Int

@ExternalSymbolName("org_jetbrains_skia_Canvas__1nSaveLayer")
@ExternalCode("Module['asm']['org_jetbrains_skia_Canvas__1nSaveLayer']")
...
@ExternalCode("Module['asm']['org_jetbrains_skia_Canvas__1nSaveLayerRect']")
