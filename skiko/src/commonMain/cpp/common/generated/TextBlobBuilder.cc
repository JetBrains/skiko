...
SKIKO_EXPORT void org_jetbrains_skia_TextBlobBuilder__1nAppendRun
  (KInteropPointer __Kinstance, KNativePointer ptr, KNativePointer fontPtr, KShort* glyphsArr, KFloat x, KFloat y, KInteropPointer boundsObj) {
...
SKIKO_EXPORT void org_jetbrains_skia_TextBlobBuilder__1nAppendRunPosH
  (KInteropPointer __Kinstance, KNativePointer ptr, KNativePointer fontPtr, KShort* glyphsArr, KFloat* xsArr, KFloat y, KInteropPointer boundsObj) {
...
SKIKO_EXPORT void org_jetbrains_skia_TextBlobBuilder__1nAppendRunPos
  (KInteropPointer __Kinstance, KNativePointer ptr, KNativePointer fontPtr, KShort* glyphsArr, KFloat* posArr, KInteropPointer boundsObj) {
...
SKIKO_EXPORT void org_jetbrains_skia_TextBlobBuilder__1nAppendRunRSXform
  (KInteropPointer __Kinstance, KNativePointer ptr, KNativePointer fontPtr, KShort* glyphsArr, KFloat* xformArr) {
